                    ...
                    <ul className="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
                        ...
                        <>
                            ...
                            <li className="text-gray-600 md:mr-12 hover:text-accent">
                                <button onClick={logout} className="rounded-full border-2 border-gray-600 px-6 py-1 font-medium text-gray-600 transition-colors hover:bg-gray-600 hover:text-whitey">
                                    Sair
                                </button>
                            </li>
                        </>
                    ) : (
                        <li className="text-gray-600 md:mr-12 hover:text-accent"><Link to="/login" className="rounded-full border-2 border-gray-600 px-6 py-1 font-medium text-gray-600 transition-colors hover:bg-gray-600 hover:text-whitey">Login</Link></li>
                    )}
